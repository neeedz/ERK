...
--- specialize all parameter values k_i and total concentrations c_i as 1.
...
f1 = -x1*x2 + x5 + x6;
f2 = -x1*x2 - x2*x10 + 2*x7 + x8;
f3 = -x3*x12 - x3*x9 + 2*x5 + x6;
f4 = x3*x12 - x4;
f5 = x4 - 2*x5;
f6 = x3*x9 - x6;
f7 = x11 - 2*x7;
...
---reduced ERK network
SH = CC[x1,x2,x3,x4,x5,x6,x7,x8,x9,x10];
...
fullyirrERK = {f1,f2,f3,f4,f5,f6,f7,f8,f9,f10};
